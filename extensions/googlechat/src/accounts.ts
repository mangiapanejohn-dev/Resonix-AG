...
export function listGoogleChatAccountIds(cfg: ResonixConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ResonixConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ResonixConfig): ResolvedGoogleChatAccount[] {
