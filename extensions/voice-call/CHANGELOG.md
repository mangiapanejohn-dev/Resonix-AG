...
- Version alignment with core Resonix release numbers.
...
- First public release of the @resonix/voice-call plugin.
...
- CLI: `resonix voicecall` commands (call/start/continue/speak/end/status/tail/expose).
