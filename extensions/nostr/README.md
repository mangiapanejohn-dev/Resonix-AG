...
Nostr DM channel plugin for Resonix using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Resonix. It enables your bot to:
...
# Configure resonix to use local relay
