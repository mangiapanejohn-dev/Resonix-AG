...
export function listZalouserAccountIds(cfg: ResonixConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ResonixConfig): string {
...
function mergeZalouserAccountConfig(cfg: ResonixConfig, accountId: string): ZalouserAccountConfig {
