...
export function listMattermostAccountIds(cfg: ResonixConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ResonixConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ResonixConfig): ResolvedMattermostAccount[] {
