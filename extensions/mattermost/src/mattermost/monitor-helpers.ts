...
export { createDedupeCache, rawDataToString } from "resonix/plugin-sdk";
...
function listAgents(cfg: ResonixConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: ResonixConfig, agentId: string): string | undefined {
