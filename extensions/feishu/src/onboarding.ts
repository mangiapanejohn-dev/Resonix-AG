...
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "resonix/plugin-sdk";
...
function setFeishuDmPolicy(cfg: ResonixdbotConfig, dmPolicy: DmPolicy): ResonixdbotConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: ResonixdbotConfig, allowFrom: string[]): ResonixdbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
