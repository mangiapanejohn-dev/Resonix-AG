...
export function listZaloAccountIds(cfg: ResonixConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: ResonixConfig): string {
...
function mergeZaloAccountConfig(cfg: ResonixConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ResonixConfig): ResolvedZaloAccount[] {
