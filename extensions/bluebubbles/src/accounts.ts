...
export function listBlueBubblesAccountIds(cfg: ResonixConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ResonixConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ResonixConfig): ResolvedBlueBubblesAccount[] {
