...
import { resolveChannelMediaMaxBytes, type ResonixConfig } from "resonix/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: ResonixConfig; accountId?: string }): string[] {
