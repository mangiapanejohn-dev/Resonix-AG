...
This directory contains the **BlueBubbles external channel plugin** for Resonix.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `resonix/plugin-sdk` helpers.
