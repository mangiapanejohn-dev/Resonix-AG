...
summary: "`resonix skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- ResonixHub 安装：[ResonixHub](/tools/clawhub)

## 命令

```bash
resonix skills list
resonix skills list --eligible
resonix skills info <name>
resonix skills check
```
