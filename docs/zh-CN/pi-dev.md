...
本指南总结了在 Resonix 中开发 Pi 集成的合理工作流程。
...
状态存储在 Resonix 状态目录下。默认为 `~/.resonix`。如果设置了 `RESONIX_STATE_DIR`，则使用该目录。
...
- https://docs.resonix.ai/testing
- https://docs.resonix.ai/start/getting-started
