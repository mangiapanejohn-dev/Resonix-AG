...
Resonix treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Resonix “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Resonix can see that group and respond there.
...
Translation: allowlisted senders can trigger Resonix by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@resonix", "resonix", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
