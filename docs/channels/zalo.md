...
- Install via CLI: `resonix plugins install @resonix/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `resonix plugins install ./extensions/zalo`
   - From npm (if published): `resonix plugins install @resonix/zalo`
...
- Approve via:
  - `resonix pairing list zalo`
  - `resonix pairing approve zalo <CODE>`
...
- Example: `resonix message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `resonix channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `resonix logs --follow`
