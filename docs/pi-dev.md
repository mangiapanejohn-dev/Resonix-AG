...
This guide summarizes a sane workflow for working on the pi integration in Resonix.
...
- Trigger the agent directly:
  - `pnpm resonix agent --message "Hello" --thinking low`
...
State lives under the Resonix state directory. Default is `~/.resonix`. If `RESONIX_STATE_DIR` is set, use that directory instead.

To reset everything:

- `resonix.json` for config
...
- [https://docs.resonix.ai/testing](https://docs.resonix.ai/testing)
- [https://docs.resonix.ai/start/getting-started](https://docs.resonix.ai/start/getting-started)
