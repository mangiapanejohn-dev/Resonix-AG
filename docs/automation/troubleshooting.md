...
resonix system heartbeat last
resonix logs --follow
resonix config get agents.defaults.heartbeat
resonix channels status --probe
```
...
```bash
resonix config get agents.defaults.heartbeat.activeHours
resonix config get agents.defaults.heartbeat.activeHours.timezone
resonix config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
resonix cron list
resonix logs --follow
```
