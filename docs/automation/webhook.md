...
read_when:
  ...
  - Wiring external systems into Resonix
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Resonix config directory (typically `~/.resonix/hooks/transforms`).
...
- `resonix webhooks gmail setup` writes `hooks.gmail` config for `resonix webhooks gmail run`.
