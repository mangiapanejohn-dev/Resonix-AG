...
You can point Resonix at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Resonix
...
- [Anthropic provider](/providers/anthropic) - Native Resonix integration with Claude setup-token or API keys
