---
summary: "Use Synthetic's Anthropic-compatible API in Resonix"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Resonix registers it as the
...
Note: Resonix's Anthropic client appends `/v1` to the base URL, so use
