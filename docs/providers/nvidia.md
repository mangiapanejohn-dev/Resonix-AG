---
summary: "Use NVIDIA's OpenAI-compatible API in Resonix"
read_when:
  - You want to use NVIDIA models in Resonix
...
resonix onboard --auth-choice skip
resonix models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
