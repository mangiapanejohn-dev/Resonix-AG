---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Resonix"
read_when:
  - You want Xiaomi MiMo models in Resonix
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Resonix uses
