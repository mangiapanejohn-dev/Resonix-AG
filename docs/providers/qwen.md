---
summary: "Use Qwen OAuth (free tier) in Resonix"
read_when:
  - You want to use Qwen with Resonix
...
If you already logged in with the Qwen Code CLI, Resonix will sync credentials
