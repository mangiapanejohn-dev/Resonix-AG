---
summary: "Use Qianfan's unified API to access many models in Resonix"
read_when:
...
3. Resonix installed on your system
...
4. Copy the API key for use with Resonix

## CLI setup

```bash
resonix onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Resonix Configuration](/gateway/configuration)
