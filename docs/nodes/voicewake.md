...
Resonix treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.resonix/settings/voicewake.json`

Shape:

```json
{ "triggers": ["resonix", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
