---
summary: "First-run onboarding flow for Resonix (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Resonix">
...
<Step title="CLI">
  ...
  The app can install the global `resonix` CLI via npm/pnpm so terminal
