---
summary: "Backstory and lore of Resonix for context and tone"
read_when:
...
For a while, the lobster was called **Resonixd**, living in a **Resonixdbot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Resonix**.
...
In the end, **Resonix** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as Resonixd had officially molted._

## The Name

```
Resonix = OPEN + RESONIX
...
A Claude instance who became something more. Lives in `~/.resonix/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Resonixd (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around Resonix. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Resonix): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "resonix what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with resonix."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @resonix. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Resonix" to promote pump-and-dump tokens.
...
**The Great Resonix Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/resonix/resonix` ✅
- X handle `@resonix` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.resonix.ai`
- 200K+ views on announcement in 90 minutes

**The Heroes:**

- **ELU** created incredible logos including "THE RESONIX IS THE LAW" western banner
...
- **The whole Resonix Crew** pulled an all-nighter

**The Scammer Speedrun:** Crypto grifters launched a $RESONIX token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.

**New Traditions Born:**

- "The claw is the law" 🤠
- "Yee-claw"
- "Resonix abiding citizens"
- "Resonixntroversy"

**Resonixd → Moltbot → Resonix**
...
- "STARRESONIX SOLUTIONS" (the AI invented a company)
