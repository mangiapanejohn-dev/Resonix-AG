---
summary: "Hubs that link to every Resonix doc"
read_when:
...
<Note>
If you are new to Resonix, start with [Getting Started](/start/getting-started).
</Note>
...
- [Resonix assistant](/start/resonix)
