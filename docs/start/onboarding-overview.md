---
summary: "Overview of Resonix onboarding options and flows"
read_when:
...
Resonix supports multiple onboarding paths depending on where the Gateway runs
...
- [`resonix onboard` command](/cli/onboard)

## macOS app onboarding

Use the Resonix app when you want a fully guided setup on macOS. Docs:
