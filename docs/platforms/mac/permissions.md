...
- Same path: run the app from a fixed location (for Resonix, `dist/Resonix.app`).
...
Workaround: move files into the Resonix workspace (`~/.resonix/workspace`) if you want to avoid per-folder grants.
