...
read_when:
  - You are building a Resonix plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (resonix.plugin.json)

Every plugin **must** ship a `resonix.plugin.json` file in the **plugin root**.
Resonix uses this manifest to validate configuration **without executing plugin
