...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.resonix", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.resonix", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ResonixProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
