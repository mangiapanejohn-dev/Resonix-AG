...
public enum ResonixTalkCommand: String, Codable, Sendable {
...
public struct ResonixTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ResonixTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
