...
public enum ResonixCanvasA2UICommand: String, Codable, Sendable {
...
public struct ResonixCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ResonixCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
