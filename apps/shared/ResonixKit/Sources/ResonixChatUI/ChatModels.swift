...
public typealias ResonixPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ResonixPlatformImage = UIImage
#endif

public struct ResonixChatUsageCost: Codable, Hashable, Sendable {
...
public struct ResonixChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ResonixChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ResonixChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ResonixChatMessageContent: Codable, Hashable, Sendable {
...
public struct ResonixChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ResonixChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ResonixChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ResonixChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ResonixChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ResonixChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ResonixChatMessageContent].self, forKey: .content) {
...
public struct ResonixChatHistoryPayload: Codable, Sendable {
...
public struct ResonixSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ResonixSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ResonixSessionPreviewItem]
}

public struct ResonixSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ResonixSessionPreviewEntry]

    public init(ts: Int, previews: [ResonixSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ResonixChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ResonixChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ResonixAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ResonixChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ResonixGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ResonixPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ResonixPlatformImage?
...
public struct ResonixChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
