...
@MainActor
public struct ResonixChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ResonixChatViewModel
    ...
    public init(
        viewModel: ResonixChatViewModel,
    ...
    private var visibleMessages: [ResonixChatMessage] {
        let base: [ResonixChatMessage]
    ...
    private func mergeToolResults(in messages: [ResonixChatMessage]) -> [ResonixChatMessage] {
    ...
    private func isToolResultMessage(_ message: ResonixChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ResonixChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ResonixChatMessage) -> String {
