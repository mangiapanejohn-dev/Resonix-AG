## Resonix Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_resonix-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm resonix gateway --port 18789 --verbose
```
