...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.resonix.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Resonix", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Resonix gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Resonix.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "ResonixShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Resonix is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Resonix Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("resonix-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
