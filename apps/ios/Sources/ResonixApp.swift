...
final class ResonixAppDelegate: NSObject, UIApplicationDelegate {
    private let logger = Logger(subsystem: "ai.resonix.ios", category: "Push")
    private let backgroundWakeLogger = Logger(subsystem: "ai.resonix.ios", category: "BackgroundWake")
    private static let wakeRefreshTaskIdentifier = "ai.resonix.ios.bgrefresh"
...
@main
struct ResonixApp: App {
    @State private var appModel: NodeAppModel
    @State private var gatewayController: GatewayConnectionController
    @UIApplicationDelegateAdaptor(ResonixAppDelegate.self) private var appDelegate
...
extension ResonixApp {
    private static func installUncaughtExceptionLogger() {
        NSLog("Resonix: installing uncaught exception handler")
