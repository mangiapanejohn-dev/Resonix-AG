...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ResonixPhotosLatestParams) async throws -> ResonixPhotosLatestPayload {
        ...
        var results: [ResonixPhotoPayload] = []
        ...
        return ResonixPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ResonixPhotoPayload
    {
