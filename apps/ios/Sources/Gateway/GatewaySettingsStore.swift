...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.resonix.gateway"
    private static let nodeService = "ai.resonix.node"
    private static let talkService = "ai.resonix.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.resonix.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.resonix.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("resonix-gateway.log")
    }
