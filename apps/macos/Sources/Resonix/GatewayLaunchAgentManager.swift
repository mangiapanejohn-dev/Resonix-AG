...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.resonix", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".resonix/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.resonixCommand(
            subcommand: "gateway",
