...
enum UIStrings {
    static let welcomeTitle = "Welcome to Resonix"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "resonix.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ResonixOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ResonixChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g resonix@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ResonixChatViewModel(
