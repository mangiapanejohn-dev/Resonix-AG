...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ResonixConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ResonixConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ResonixConfigFile.loadDict()
            ...
            ResonixConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/resonix"
        state.remoteCliPath = ""
        return state
    }
}
