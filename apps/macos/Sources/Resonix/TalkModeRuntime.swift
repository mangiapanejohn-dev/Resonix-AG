...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.resonix", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.resonix", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ResonixChatMessage] = messages.compactMap { item in
