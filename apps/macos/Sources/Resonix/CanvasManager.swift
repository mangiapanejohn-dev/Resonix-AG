...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.resonix", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Resonix/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__resonix__/a2ui/").absoluteString + "?platform=macos"
    }
