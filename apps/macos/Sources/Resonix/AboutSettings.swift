...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/resonix/resonix") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/resonix/resonix")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://resonix.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ResonixBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ResonixBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ResonixGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ResonixGitCommit") as? String) ??
            "unknown"
    }
