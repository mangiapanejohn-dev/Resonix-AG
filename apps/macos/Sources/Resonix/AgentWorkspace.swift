...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.resonix", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ResonixConfigFile.defaultWorkspaceURL() }
