...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Resonix token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: ResonixOAuthStore.AnthropicOAuthStatus = ResonixOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.resonix", category: "anthropic-oauth")
...
enum ResonixOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let resonixOAuthDirEnv = "OPENCLAW_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Resonix OAuth token file not found"
            case .unreadableFile: "Resonix OAuth token file not readable"
            case .invalidJSON: "Resonix OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Resonix OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Resonix OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.resonixOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".resonix", isDirectory: true)
