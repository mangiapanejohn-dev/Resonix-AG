...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.resonix", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Resonix windows, but below the system’s pop-up menus.
