...
enum ResonixConfigFile {
    private static let logger = Logger(subsystem: "ai.resonix", category: "config")
    ...
    static func stateDirURL() -> URL {
        ResonixPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ResonixPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-resonix-config-file",
            "event": "config.write",
