...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.resonix.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if standard.bool(forKey: "resonix.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "resonix.nixMode") { return true }
