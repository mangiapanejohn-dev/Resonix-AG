...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .resonixSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ResonixPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ResonixPaths.stateDirURL.path
...
extension Notification.Name {
    static let resonixSelectSettingsTab = Notification.Name("resonixSelectSettingsTab")
}
