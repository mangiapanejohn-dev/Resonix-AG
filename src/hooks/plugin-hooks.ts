...
import type { ResonixPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ResonixPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ResonixPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
