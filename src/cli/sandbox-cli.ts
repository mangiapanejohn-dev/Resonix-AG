...
const SANDBOX_EXAMPLES = {
  main: [
    ["resonix sandbox list", "List all sandbox containers."],
    ["resonix sandbox list --browser", "List only browser containers."],
    ["resonix sandbox recreate --all", "Recreate all containers."],
    ["resonix sandbox recreate --session main", "Recreate a specific session."],
    ["resonix sandbox recreate --agent mybot", "Recreate agent containers."],
    ["resonix sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["resonix sandbox list", "List all sandbox containers."],
    ["resonix sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["resonix sandbox recreate --all", "Recreate all containers."],
    ["resonix sandbox recreate --session main", "Recreate a specific session."],
    ["resonix sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["resonix sandbox recreate --browser --all", "Recreate only browser containers."],
    ["resonix sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["resonix sandbox explain", "Show effective sandbox config."],
    ["resonix sandbox explain --session agent:main:main", "Explain a specific session."],
    ["resonix sandbox explain --agent work", "Explain an agent sandbox."],
    ["resonix sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.resonix.ai/cli/sandbox")}\n`,
    )
    .action(() => {
