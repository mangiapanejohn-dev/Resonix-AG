    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["resonix channels list", "List configured channels and auth profiles."],
          ["resonix channels status --probe", "Run channel status checks and probes."],
          [
            "resonix channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["resonix channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.resonix.ai/cli/channels",
        )}\n`,
    );
