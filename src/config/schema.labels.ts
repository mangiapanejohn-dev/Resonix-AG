...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.media.audio.echoTranscript": "Audio Transcript Echo",
  "tools.media.audio.echoFormat": "Audio Transcript Echo Format",
  ...
  "cli.banner.taglineMode": "CLI Tagline Mode",
  ...
  "channels.telegram.streaming": "Telegram Stream Toggle (Legacy)",
  "channels.telegram.groups.*.disableAudioPreflight": "Telegram Group Audio Preflight Disable",
  "channels.telegram.groups.*.topics.*.disableAudioPreflight":
    "Telegram Topic Audio Preflight Disable",
  ...
  "channels.discord.disableAudioPreflight": "Discord Audio Preflight Disable",
