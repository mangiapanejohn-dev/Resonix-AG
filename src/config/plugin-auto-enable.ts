...
function isTelegramConfigured(cfg: ResonixConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ResonixConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: ResonixConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ResonixConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ResonixConfig): boolean {
...
function isIMessageConfigured(cfg: ResonixConfig): boolean {
...
function isWhatsAppConfigured(cfg: ResonixConfig): boolean {
...
function isGenericChannelConfigured(cfg: ResonixConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ResonixConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ResonixConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ResonixConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ResonixConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: ResonixConfig, pluginId: string): ResonixConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
