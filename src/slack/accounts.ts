...
function mergeSlackAccountConfig(cfg: ResonixConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ResonixConfig): ResolvedSlackAccount[] {
