...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/resonix/resonix/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.RESONIX_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.resonix/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: ResonixConfig = {
    ...params.cfg,
