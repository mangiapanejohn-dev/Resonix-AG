...
import { resolvePreferredResonixTmpDir } from "../infra/tmp-resonix-dir.js";
import { readLoggingConfig } from "./config.js";
import type { ConsoleStyle } from "./console.js";
import { type LogLevel, levelToMinLevel, normalizeLogLevel } from "./levels.js";
import { loggingState } from "./state.js";

export const DEFAULT_LOG_DIR = resolvePreferredResonixTmpDir();
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "resonix.log"); // legacy single-file path

const LOG_PREFIX = "resonix";
...
function resolveSettings(): ResolvedSettings {
  ...
  const defaultLevel =
    process.env.VITEST === "true" && process.env.RESONIX_TEST_FILE_LOG !== "1" ? "silent" : "info";
