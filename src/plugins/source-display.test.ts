...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/resonix/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/resonix/extensions",
        global: "/Users/x/.resonix/extensions",
        workspace: "/Users/x/ws/.resonix/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.resonix/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/resonix/extensions",
        global: "/Users/x/.resonix/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.resonix/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/resonix/extensions",
        global: "/Users/x/.resonix/extensions",
