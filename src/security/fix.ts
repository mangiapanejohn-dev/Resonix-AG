...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ResonixConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ResonixConfig; env: NodeJS.ProcessEnv }): {
  cfg: ResonixConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
