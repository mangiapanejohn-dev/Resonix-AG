...
beforeAll(async () => {
  previousToken = process.env.RESONIX_GATEWAY_TOKEN;
  process.env.RESONIX_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "resonix-ios", platform: "ios" },
  { clientId: "resonix-android", platform: "android" },
