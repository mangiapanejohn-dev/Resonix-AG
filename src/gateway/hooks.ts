...
export function resolveHooksConfig(cfg: ResonixConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: ResonixConfig, defaultAgentId: string): Set<string> {
