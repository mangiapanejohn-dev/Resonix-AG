...
import { type ResonixConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ResonixConfig): string[] {
...
export function listAgentsForGateway(cfg: ResonixConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ResonixConfig): string {
...
function resolveSessionStoreAgentId(cfg: ResonixConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ResonixConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ResonixConfig): GatewaySessionsDefaults {
