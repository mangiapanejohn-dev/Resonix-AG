...
import type { ResonixConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: ResonixConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: ResonixConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: ResonixConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: ResonixConfig) => void;
  log: {
