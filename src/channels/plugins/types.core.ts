...
export type ChannelAgentToolFactory = (params: { cfg?: ResonixConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ResonixConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ResonixConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ResonixConfig }) => boolean;
  supportsCards?: (params: { cfg: ResonixConfig }) => boolean;
