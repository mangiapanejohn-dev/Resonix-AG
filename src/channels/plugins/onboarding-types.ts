...
export type PromptAccountIdParams = {
  ...
  label: string;
  currentId?: string;
  listAccountIds: (cfg: ResonixConfig) => string[];
...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: ResonixConfig) => DmPolicy;
  setPolicy: (cfg: ResonixConfig, policy: DmPolicy) => ResonixConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: ResonixConfig) => ResonixConfig;
};
