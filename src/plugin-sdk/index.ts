...
export type { ResonixConfig } from "../config/config.js";
/** @deprecated Use ResonixConfig instead */
export type { ResonixConfig as ResonixdbotConfig } from "../config/config.js";
