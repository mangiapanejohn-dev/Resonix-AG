...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("resonix");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "resonix");
