...
export function summarizeExistingConfig(config: ResonixConfig): string {
  const rows: string[] = [];
...
export function printWizardHeader(runtime: RuntimeEnv) {
  const header = [
    ...
    "▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀",
    "                  👾 RESONIX 👾                    ",
    "   Autonomous AI Agent - Created by MarkEllington   ",
    " ",
  ].join("\n");
  runtime.log(header);
}
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.resonix.ai/gateway/remote",
    "https://docs.resonix.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
