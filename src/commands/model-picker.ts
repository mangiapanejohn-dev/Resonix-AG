...
type PromptDefaultModelResult = { model?: string; config?: ResonixConfig };
...
function resolveConfiguredModelRaw(cfg: ResonixConfig): string {
...
function resolveConfiguredModelKeys(cfg: ResonixConfig): string[] {
...
export function applyPrimaryModel(cfg: ResonixConfig, model: string): ResonixConfig {
...
export function applyModelAllowlist(cfg: ResonixConfig, models: string[]): ResonixConfig {
  const defaults = cfg.agents?.defaults;
