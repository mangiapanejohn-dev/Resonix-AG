...
export function applyVercelAiGatewayProviderConfig(cfg: ResonixConfig): ResonixConfig {
...
export function applyVercelAiGatewayConfig(cfg: ResonixConfig): ResonixConfig {
