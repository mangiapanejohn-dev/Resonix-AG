...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Resonix status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("resonix security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("resonix security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.resonix.ai/faq");
  runtime.log("Troubleshooting: https://docs.resonix.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("resonix status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("resonix logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("resonix status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("resonix gateway probe")}`);
  }
}
