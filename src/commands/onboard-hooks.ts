...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.resonix.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("resonix hooks list")}`,
      `  ${formatCliCommand("resonix hooks enable <name>")}`,
      `  ${formatCliCommand("resonix hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
