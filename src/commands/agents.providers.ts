...
function resolveDefaultAccountId(cfg: ResonixConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ResonixConfig): boolean {
...
export function summarizeBindings(cfg: ResonixConfig, bindings: AgentBinding[]): string[] {
