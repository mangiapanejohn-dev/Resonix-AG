...
function mergeIMessageAccountConfig(cfg: ResonixConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: ResonixConfig): ResolvedIMessageAccount[] {
