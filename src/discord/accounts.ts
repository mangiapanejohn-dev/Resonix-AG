...
function mergeDiscordAccountConfig(cfg: ResonixConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: ResonixConfig): ResolvedDiscordAccount[] {
