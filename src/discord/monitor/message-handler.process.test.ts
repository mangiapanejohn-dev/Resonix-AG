...
const resolveStorePath = vi.fn(() => "/tmp/resonix-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/resonix-discord-process-test-sessions.json");
});
