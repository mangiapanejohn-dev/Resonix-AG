...
describe("agent components", () => {
  const createCfg = (): ResonixConfig => ({}) as ResonixConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/resonix-sessions-test.json");
  });
