...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.resonix.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", RESONIX_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.resonix.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.resonix.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when RESONIX_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.resonix.gateway.plist",
    },
    {
      name: "uses profile-specific label when RESONIX_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", RESONIX_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.resonix.jbphoenix.plist",
    },
    {
      name: "prefers RESONIX_LAUNCHD_LABEL over RESONIX_PROFILE",
      env: {
        HOME: "/Users/test",
        RESONIX_PROFILE: "jbphoenix",
        RESONIX_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from RESONIX_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        RESONIX_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty RESONIX_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        RESONIX_PROFILE: "myprofile",
        RESONIX_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.resonix.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
