...
export function listWhatsAppAuthDirs(cfg: ResonixConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ResonixConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ResonixConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ResonixConfig): ResolvedWhatsAppAccount[] {
