...
describe("createResonixCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createResonixCodingTools({
      config,
    ...
    const anthropicTools = createResonixCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createResonixCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createResonixCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
