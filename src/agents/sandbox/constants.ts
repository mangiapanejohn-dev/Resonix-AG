...
export const DEFAULT_SANDBOX_IMAGE = "resonix-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "resonix-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "resonix-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "resonix-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "resonix-sbx-browser-";
