...
function resolveWatchPaths(workspaceDir: string, config?: ResonixConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ResonixConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ResonixConfig }) {
