...
const CLEANUP_STATE_KEY = Symbol.for("resonix.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("resonix.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("resonix.sessionWriteLockWatchdogState");
