...
function resolveAvatarSource(cfg: ResonixConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ResonixConfig, agentId: string): AgentAvatarResolution {
