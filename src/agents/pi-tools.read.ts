...
function resolveAdaptiveReadMaxBytes(options?: ResonixReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createResonixReadTool(base, {
...
export function createResonixReadTool(
  base: AnyAgentTool,
  options?: ResonixReadToolOptions,
): AnyAgentTool {
