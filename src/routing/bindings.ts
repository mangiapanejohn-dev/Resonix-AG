...
export function listBindings(cfg: ResonixConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: ResonixConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ResonixConfig) {
