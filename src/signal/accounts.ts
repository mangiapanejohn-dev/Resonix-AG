...
function mergeSignalAccountConfig(cfg: ResonixConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ResonixConfig): ResolvedSignalAccount[] {
