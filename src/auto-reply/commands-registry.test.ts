...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@resonix", { botUsername: "resonix" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@resonix args", {
        botUsername: "resonix",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "resonix" })).toBe(
      "/help@otherbot",
    );
  });
