...
function resolveMentionPatterns(cfg: ResonixConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ResonixConfig | undefined, agentId?: string): RegExp[] {
