...
# Output:
# - dist/Resonix.app
# - dist/Resonix-<version>.zip
# - dist/Resonix-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Resonix-$VERSION.zip"
DMG="$ROOT_DIR/dist/Resonix-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Resonix-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Resonix-$VERSION.dSYM.zip"
