...
show_usage() {
    cat << EOF
clawlog - Resonix Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Resonix logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Resonix logs flow through the macOS unified log (subsystem: ai.resonix).
