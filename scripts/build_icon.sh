...
# Defaults target the Resonix assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Resonix/Resources/Resonix.icns"}
